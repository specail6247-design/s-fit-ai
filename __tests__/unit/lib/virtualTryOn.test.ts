...
describe('Cinematic Video Generation', () => {
  ...
  it('should generate cinematic video successfully', async () => {
    ...
    // Mock the SDK response which returns an object for the task where output is inside it
    mockRunwayRetrieve.mockResolvedValue({ id: 'task-123', status: 'SUCCEEDED', output: ['https://runwayml.com/video.mp4'] });
