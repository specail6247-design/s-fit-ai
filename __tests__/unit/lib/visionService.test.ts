...
describe('Vision Service', () => {
  ...
  describe('getComplementaryItems', () => {
    ...
    it('should prioritize matching colors (black/white)', () => {
        ...
        const baseItem = getAllItems()[0];
        const blackItem = { ...baseItem, colors: ['Black'], category: 'tops' as const };
        const recommendations = getComplementaryItems(blackItem as unknown as ClothingItem);
