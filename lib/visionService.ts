...
export async function analyzeClothingStyle(imageUrl: string): Promise<ClothingStyleAnalysis> {
  // SECURITY: Prevent API key exposure to the client. Do not use dangerouslyAllowBrowser or NEXT_PUBLIC_ keys for external AI SDKs.
  // Proxy real API calls through secure server endpoints instead.
