    ...
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-sans">
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        ...
        <div className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900 group">
          <LuxuryImageDistortion
            ...
            className="absolute inset-0 z-0 editorial-image"
          />
          ...
          {/* 3D UI Overlays */}
          <motion.div
            className="absolute bottom-6 left-4 right-4 flex justify-between items-end z-20 pointer-events-none"
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            <div className="text-right">
              ...
              <motion.h1 variants={itemVariants} className="text-white text-3xl font-extralight leading-tight font-[family-name:var(--font-cinzel)]">Metallic Silk <br/><span className="font-bold">Evening Blazer</span></motion.h1>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          variants={containerVariants}
        >
          <motion.div variants={itemVariants} className="flex flex-wrap gap-3 bg-[#1a1a1a]/60 backdrop-blur-xl border border-[#2d2d2d] p-4 rounded-xl">
            <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
              <p className="text-[#ecab13] text-xl font-bold leading-tight font-[family-name:var(--font-space)]">99.8%</p>
            ...
            <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
              <p className="text-white text-xl font-bold leading-tight font-[family-name:var(--font-space)]">High</p>
              <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider">Metalness</p>
            </div>
            <div className="w-px h-10 bg-[#2d2d2d] self-center"></div>
            <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
              <p className="text-white text-xl font-bold leading-tight font-[family-name:var(--font-space)]">0.85</p>
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-zinc-400 text-sm leading-relaxed mb-6 font-[family-name:var(--font-space)]">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex gap-4 overflow-x-auto px-4 no-scrollbar pb-2">
            <div 
              className="min-w-[160px] aspect-square rounded-lg bg-zinc-800 bg-cover bg-center border border-[#2d2d2d] editorial-image"
      ...
      >
        <div className="flex flex-col flex-1">
          ...
          <p className="text-white text-xl font-bold font-[family-name:var(--font-space)]">$2,850</p>
        </div>
