...
export default function LuxuryGarmentDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-sans [font-family:var(--font-space-grotesk)] cursor-none">
      <LuxuryCursor />
      {/* Top Navigation */}
      <div className="fixed top-0 z-50 w-full bg-[#f8f7f6]/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md">
        <div className="flex items-center p-4 justify-between max-w-md mx-auto">
          ...
          <div className="flex w-10 items-center justify-end">
            <motion.button whileTap={{ scale: 0.9 }} className="flex size-10 items-center justify-center rounded-full bg-white/10 text-white hover:bg-white/20 transition-colors">
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        ...
        <div className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900">
          ...
          <div className="absolute bottom-6 left-4 right-4 flex justify-between items-end">
            <div className="bg-black/40 backdrop-blur-md rounded-lg p-2 flex flex-col gap-2 border border-white/10">
              <motion.button whileTap={{ scale: 0.9 }} className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded"><span className="material-symbols-outlined text-sm">zoom_in</span></motion.button>
              <motion.button whileTap={{ scale: 0.9 }} className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded"><span className="material-symbols-outlined text-sm">360</span></motion.button>
              <motion.button whileTap={{ scale: 0.9 }} className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded"><span className="material-symbols-outlined text-sm">light_mode</span></motion.button>
            </div>
            <motion.div
            ...
            >
              ...
              <motion.h1 variants={itemVariants} className="text-white text-3xl font-extralight leading-tight [font-family:var(--font-cinzel)]">Metallic Silk <br/><span className="font-bold">Evening Blazer</span></motion.h1>
            </motion.div>
          </div>
        </div>
        ...
        <div className="px-4 -mt-4 relative z-10">
          <motion.div
            className="flex flex-wrap gap-3 bg-[#1a1a1a]/60 backdrop-blur-xl border border-[#2d2d2d] p-4 rounded-xl"
        ...
        >
          <motion.div variants={itemVariants} className="flex items-center justify-between mb-4">
            <h2 className="text-white text-xs font-bold tracking-[0.2em] uppercase [font-family:var(--font-cinzel)]">Material Science</h2>
        ...
        >
          <motion.div variants={itemVariants} className="px-4 flex items-center justify-between mb-4">
            <h2 className="text-white text-xs font-bold tracking-[0.2em] uppercase [font-family:var(--font-cinzel)]">Detail Macro View</h2>
      ...
      <div className="fixed bottom-0 w-full p-4 pb-8 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-[#2d2d2d] flex gap-4 items-center z-50">
        ...
        <motion.div className="flex-[2]" whileTap={{ scale: 0.95 }}>
          <Link href="/luxury/fitting" className="w-full bg-gradient-to-br from-[#ecab13] to-[#c48a0a] text-[#0a0a0a] h-14 rounded-xl flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(236,171,19,0.3)] hover:scale-[1.02] transition-transform">
