  ...
  return (
    <div className={`min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white ${spaceGrotesk.className}`}>
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        ...
        <div className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900" style={{ filter: 'saturate(0.9) contrast(1.1)' }}>
          ...
          <div className="absolute bottom-6 left-4 right-4 flex justify-between items-end">
            ...
            <div className="text-right">
              ...
              <h1 className={`text-white text-3xl font-extralight leading-tight ${cinzel.className}`}>Metallic Silk <br/><span className="font-bold">Evening Blazer</span></h1>
            </div>
          </div>
        </div>
        ...
        >
        {/* Material Stats */}
        <motion.div variants={fadeUpItem} className="px-4 -mt-4 relative z-10">
        ...
        <motion.div variants={fadeUpItem} className="mt-8 px-4">
        ...
        {/* Comparison Table */}
        <motion.div variants={fadeUpItem} className="px-4 py-4 bg-[#1a1a1a]/30 border-y border-[#2d2d2d] mb-8">
      ...
      <div className="fixed bottom-0 w-full p-4 pb-8 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-[#2d2d2d] flex gap-4 items-center z-50">
        ...
        <Link href="/luxury/fitting" passHref legacyBehavior>
          <motion.a
            whileTap={{ scale: 0.95 }}
