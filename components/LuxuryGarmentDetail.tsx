  ...
  return (
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-sans">
      ...
      >
        ...
        <motion.div variants={staggerItem} className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900 saturate-[0.9] contrast-[1.1]">
        ...
        {/* Material Stats */}
        <motion.div variants={staggerItem} className="px-4 -mt-4 relative z-10">
        ...
        <motion.div variants={staggerItem} className="mt-8 px-4">
        ...
        <motion.div variants={staggerItem} className="mb-8">
          ...
          <div className="flex gap-4 overflow-x-auto px-4 no-scrollbar pb-2 saturate-[0.9] contrast-[1.1]">
            <div 
        ...
        {/* Comparison Table */}
        <motion.div variants={staggerItem} className="px-4 py-4 bg-[#1a1a1a]/30 border-y border-[#2d2d2d] mb-8">
      ...
      <div className="fixed bottom-0 w-full p-4 pb-8 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-[#2d2d2d] flex gap-4 items-center z-50">
        ...
        <Link href="/luxury/fitting" className="flex-[2] bg-gradient-to-br from-[#ecab13] to-[#c48a0a] text-[#0a0a0a] h-14 rounded-xl flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(236,171,19,0.3)] transition-transform">
          <motion.div whileTap={{ scale: 0.95 }} className="w-full h-full flex items-center justify-center gap-3">
