    ...
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-sans">
      ...
      <div className="fixed top-0 z-50 w-full bg-[#f8f7f6]/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md">
        <div className="flex items-center p-4 justify-between max-w-md mx-auto">
          <Link href="/" className="text-slate-900 dark:text-white flex size-10 shrink-0 items-center justify-center rounded-full bg-white/10 hover:bg-white/20 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ecab13]" aria-label="Go back">
          ...
          <div className="flex w-10 items-center justify-end">
            <button className="flex size-10 items-center justify-center rounded-full bg-white/10 text-white hover:bg-white/20 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ecab13]" aria-label="Share">
        ...
        <div className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900">
          ...
          <div className="absolute bottom-6 left-4 right-4 flex justify-between items-end">
            <div className="bg-black/40 backdrop-blur-md rounded-lg p-2 flex flex-col gap-2 border border-white/10">
              <button className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ecab13]" aria-label="Zoom in"><span className="material-symbols-outlined text-sm" aria-hidden="true">zoom_in</span></button>
              <button className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ecab13]" aria-label="360 view"><span className="material-symbols-outlined text-sm" aria-hidden="true">360</span></button>
              <button className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ecab13]" aria-label="Light mode"><span className="material-symbols-outlined text-sm" aria-hidden="true">light_mode</span></button>
            </div>
