    ...
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-sans">
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        ...
        <div className="px-4 mb-8">
          <div className="bg-[#1a1a1a]/40 border border-[#ecab13]/30 p-4 rounded-xl flex items-start gap-4">
            <span className="material-symbols-outlined text-[#ecab13] mt-1">auto_awesome</span>
            <div>
              <p className="text-white text-xs font-bold tracking-[0.2em] uppercase mb-1">AI Stylist Note</p>
        ...
        {/* Exclusive Access */}
        <div className="px-4 mb-8">
          <div className="bg-black/40 backdrop-blur-xl border border-red-900/50 p-4 rounded-xl flex flex-col items-center text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-red-900/10 via-red-900/5 to-red-900/10 animate-pulse" />
            <span className="material-symbols-outlined text-red-500 mb-2 relative z-10">lock</span>
            <p className="text-white text-xs font-bold tracking-[0.2em] uppercase mb-1 relative z-10">Exclusive Drops</p>
            <p className="text-zinc-400 text-xs mb-3 relative z-10">Obsidian Noir Colorway</p>
            <div className="bg-red-950/50 border border-red-900/50 px-4 py-2 rounded-lg relative z-10">
              <p className="text-red-400 text-sm font-mono tracking-wider font-bold">Available in {formatTime(timeLeft)}</p>
            </div>
          </div>
        </div>
      ...
      <div className="fixed bottom-0 w-full p-4 pb-8 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-[#2d2d2d] flex gap-4 items-center z-50">
        ...
        <button onClick={handleSaveLook} className="size-14 rounded-xl border border-[#2d2d2d] bg-[#1a1a1a] flex items-center justify-center text-white hover:bg-white/10 transition-colors shrink-0">
        ...
        {isVaultOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 w-full bg-[#111] border-t border-[#2d2d2d] rounded-t-3xl p-6 z-[70] max-h-[80vh] overflow-y-auto"
            >
              ...
              {savedLooks.length === 0 ? (
                ...
                <div className="space-y-4">
                  {savedLooks.map((look, i) => (
                    <div key={i} className="flex gap-4 p-3 bg-[#1a1a1a] rounded-xl border border-[#2d2d2d] items-center">
                      <div className="size-16 rounded-lg bg-zinc-800 bg-cover bg-center shrink-0" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuC5m1trvvOgtFQZrHz7J1_8YKjIyJFwuTm6b_C9mQJtDJDsOl_xtHZHfLA3MDVgFSQv4zos6OnEPUwen36ZcXZRERoj4Bj3o87kdcXjQWJ8YNc33SLIAqJUET6o0yOwx_pVzx0OswcPQw2ivo6sLma8xEumxoFQDfDsbpY-obuXwXx9h6QOzOhEDJvrFuPoRkbJEz-kJUE5bbVxawyJiFfEmGOi47n8Jrh8-zVHq14XQL_snfcQ2Ia117Mk5S2bn_rRht21zxTm58E")' }} />
                      <div className="flex-1">
                        <p className="text-white text-sm font-medium">{look}</p>
                        <p className="text-zinc-500 text-xs mt-1">Saved Collection</p>
                      </div>
