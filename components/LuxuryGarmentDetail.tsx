...
export default function LuxuryGarmentDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-sans">
      ...
      <motion.main
        className="max-w-md mx-auto pt-16 pb-32"
      ...
      >
        ...
        <div className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900">
          <div className="absolute inset-0">
             <LuxuryImageDistortion imageUrl={heroImage} />
          </div>
          <div 
          ...
          <div className="absolute bottom-6 left-4 right-4 flex justify-between items-end pointer-events-none">
            ...
            <motion.div className="text-right" variants={itemVariants}>
              <p className="text-[#ecab13] text-[10px] font-bold tracking-widest uppercase mb-1 font-[family-name:var(--font-space-grotesk)]">Authentic Render</p>
        ...
        {/* Material Stats */}
        <motion.div className="px-4 -mt-4 relative z-10" variants={itemVariants}>
          <div className="flex flex-wrap gap-3 bg-[#1a1a1a]/60 backdrop-blur-xl border border-[#2d2d2d] p-4 rounded-xl">
            <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
              <p className="text-[#ecab13] text-xl font-bold leading-tight font-[family-name:var(--font-cinzel)]">99.8%</p>
              <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider font-[family-name:var(--font-space-grotesk)]">Realism</p>
            </div>
            <div className="w-px h-10 bg-[#2d2d2d] self-center"></div>
            <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
              <p className="text-white text-xl font-bold leading-tight font-[family-name:var(--font-cinzel)]">High</p>
              <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider font-[family-name:var(--font-space-grotesk)]">Metalness</p>
            </div>
            <div className="w-px h-10 bg-[#2d2d2d] self-center"></div>
            <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
              <p className="text-white text-xl font-bold leading-tight font-[family-name:var(--font-cinzel)]">0.85</p>
              <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider font-[family-name:var(--font-space-grotesk)]">Clearcoat</p>
            </div>
          </div>
        </motion.div>

        {/* Material Science Description */}
        <motion.div className="mt-8 px-4" variants={itemVariants}>
          ...
          <p className="text-zinc-400 text-sm leading-relaxed mb-6 font-[family-name:var(--font-space-grotesk)]">
          ...
          <div className="flex gap-2 flex-wrap mb-8">
            <div className="flex h-8 items-center justify-center rounded-full border border-[#ecab13]/30 bg-[#ecab13]/10 px-4">
              <p className="text-[#ecab13] text-[11px] font-bold uppercase tracking-wider font-[family-name:var(--font-space-grotesk)]">Brushed Aluminum Finish</p>
            </div>
            <div className="flex h-8 items-center justify-center rounded-full border border-[#2d2d2d] bg-[#1a1a1a] px-4">
              <p className="text-zinc-300 text-[11px] font-bold uppercase tracking-wider font-[family-name:var(--font-space-grotesk)]">Clearcoat Tech</p>
            </div>
            <div className="flex h-8 items-center justify-center rounded-full border border-[#2d2d2d] bg-[#1a1a1a] px-4">
              <p className="text-zinc-300 text-[11px] font-bold uppercase tracking-wider font-[family-name:var(--font-space-grotesk)]">Silk Blend</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div className="mb-8" variants={itemVariants}>
          <div className="px-4 flex items-center justify-between mb-4">
            ...
            <p className="text-zinc-500 text-xs font-[family-name:var(--font-space-grotesk)]">4K Textures</p>
          </div>
        ...
        {/* Comparison Table */}
        <motion.div className="px-4 py-4 bg-[#1a1a1a]/30 border-y border-[#2d2d2d] mb-8" variants={itemVariants}>
          <div className="flex justify-between items-center py-2">
            <span className="text-zinc-500 text-xs uppercase tracking-widest font-[family-name:var(--font-space-grotesk)]">Weight</span>
            <span className="text-white text-sm font-[family-name:var(--font-space-grotesk)]">240 GSM</span>
          </div>
          <div className="flex justify-between items-center py-2 border-t border-[#2d2d2d]/50">
            <span className="text-zinc-500 text-xs uppercase tracking-widest font-[family-name:var(--font-space-grotesk)]">Composition</span>
            <span className="text-white text-sm font-[family-name:var(--font-space-grotesk)]">70% Silk, 30% Metallic Alloy</span>
          </div>
          <div className="flex justify-between items-center py-2 border-t border-[#2d2d2d]/50">
            <span className="text-zinc-500 text-xs uppercase tracking-widest font-[family-name:var(--font-space-grotesk)]">Physics Mesh</span>
            <span className="text-white text-sm font-[family-name:var(--font-space-grotesk)]">12,400 Polygons</span>
          </div>
        </motion.div>
      </motion.main>
      ...
      {/* Bottom Action Bar */}
      <motion.div
        className="fixed bottom-0 w-full p-4 pb-8 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-[#2d2d2d] flex gap-4 items-center z-50"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.8, duration: 0.5 }}
      >
        <div className="flex flex-col flex-1">
          <span className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider font-[family-name:var(--font-space-grotesk)]">Starting at</span>
        ...
        <Link href="/luxury/fitting" className="flex-[2] bg-gradient-to-br from-[#ecab13] to-[#c48a0a] text-[#0a0a0a] h-14 rounded-xl flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(236,171,19,0.3)] hover:scale-[1.02] transition-transform">
          ...
          <span className="font-bold text-sm tracking-widest uppercase font-[family-name:var(--font-space-grotesk)]">Try on Mannequin</span>
        </Link>
      </motion.div>
