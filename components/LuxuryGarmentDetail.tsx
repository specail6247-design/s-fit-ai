...
export default function LuxuryGarmentDetail() {
  ...
  return (
    <ReactLenis root>
    <div className={`min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white ${spaceGrotesk.className}`}>
      {/* Top Navigation */}
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        ...
        <div className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900 group">
          ...
          <div className="absolute bottom-6 left-4 right-4 flex justify-between items-end pointer-events-none">
            <div className="bg-black/40 backdrop-blur-md rounded-lg p-2 flex flex-col gap-2 border border-white/10 pointer-events-auto transition-transform hover:scale-105 duration-300">
              <button aria-label="Zoom In" className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded focus-visible:ring-2 outline-none"><span className="material-symbols-outlined text-sm">zoom_in</span></button>
              <button aria-label="360 View" className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded focus-visible:ring-2 outline-none"><span className="material-symbols-outlined text-sm">360</span></button>
              <button aria-label="Light Mode" className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded focus-visible:ring-2 outline-none"><span className="material-symbols-outlined text-sm">light_mode</span></button>
            </div>
            <motion.div
              initial="hidden"
              animate="show"
            ...
            >
              <motion.p variants={itemVariants} className={`text-[#ecab13] text-[10px] font-bold tracking-widest uppercase mb-1 ${spaceGrotesk.className}`}>Authentic Render</motion.p>
              <motion.h1 variants={itemVariants} className={`text-white text-3xl font-extralight leading-tight ${cinzel.className}`}>Metallic Silk <br/><span className="font-bold">Evening Blazer</span></motion.h1>
            </motion.div>
          </div>
        </div>
        ...
        >
          <div className="flex flex-wrap gap-3 bg-[#1a1a1a]/60 backdrop-blur-xl border border-[#2d2d2d] p-4 rounded-xl">
            <motion.div variants={itemVariants} className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-zinc-400 text-sm leading-relaxed mb-6">
          ...
          {/* Chips */}
          <motion.div variants={itemVariants} className="flex gap-2 flex-wrap mb-8">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <motion.div variants={itemVariants} className="px-4 flex items-center justify-between mb-4">
          ...
          <motion.div variants={itemVariants} className="flex gap-4 overflow-x-auto px-4 no-scrollbar pb-2">
            <div 
              className="min-w-[160px] aspect-square rounded-lg bg-zinc-800 bg-cover bg-center border border-[#2d2d2d] transition-transform hover:scale-105 duration-700 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]"
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex justify-between items-center py-2 border-t border-[#2d2d2d]/50">
      ...
      <div className="fixed bottom-0 w-full p-4 pb-8 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-[#2d2d2d] flex gap-4 items-center z-50">
        ...
        <Link href="/luxury/fitting" className="flex-[2] bg-gradient-to-br from-[#ecab13] to-[#c48a0a] text-[#0a0a0a] h-14 rounded-xl flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(236,171,19,0.3)] hover:scale-95 transition-transform duration-300">
