    ...
    <ReactLenis root>
      <div className={`min-h-screen bg-[#0a0a0a] text-white ${spaceGrotesk.className}`}>
        ...
        <motion.div
          ...
          className="fixed top-0 z-50 w-full bg-[#0a0a0a]/80 backdrop-blur-md border-b border-white/5"
        >
          <div className="flex items-center p-4 justify-between max-w-md mx-auto">
            <Link href="/" className="text-white flex size-10 shrink-0 items-center justify-center rounded-full bg-white/5 hover:bg-white/10 transition-colors" aria-label="Go Back">
              <span className="material-symbols-outlined">arrow_back</span>
            </Link>
            <h2 className={`text-white text-sm font-bold tracking-[0.2em] uppercase flex-1 text-center ${cinzel.className}`}>S_FIT AI</h2>
            <div className="flex w-10 items-center justify-end">
              <button className="flex size-10 items-center justify-center rounded-full bg-white/5 text-white hover:bg-white/10 transition-colors" aria-label="Share">
        ...
        <main className="max-w-md mx-auto pt-16 pb-32">
          ...
          <div className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900 border-b border-white/10">
            <div className="absolute inset-0 saturate-[0.9] contrast-[1.1]">
            ...
            <motion.div
              ...
              className="absolute bottom-6 left-4 right-4 flex justify-between items-end pointer-events-none"
            >
              <div className="bg-black/40 backdrop-blur-md rounded-lg p-2 flex flex-col gap-2 border border-white/10 pointer-events-auto">
                <button className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded transition-colors active:scale-95" aria-label="Zoom in"><span className="material-symbols-outlined text-sm">zoom_in</span></button>
                <button className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded transition-colors active:scale-95" aria-label="360 view"><span className="material-symbols-outlined text-sm">360</span></button>
                <button className="size-8 flex items-center justify-center text-white hover:bg-white/10 rounded transition-colors active:scale-95" aria-label="Lighting mode"><span className="material-symbols-outlined text-sm">light_mode</span></button>
              </div>
              <div className="text-right">
                <p className="text-[#ecab13] text-[10px] font-bold tracking-widest uppercase mb-1">Authentic Render</p>
                <h1 className={`text-white text-3xl font-extralight leading-tight drop-shadow-lg ${cinzel.className}`}>Metallic Silk <br/><span className="font-bold">Evening Blazer</span></h1>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <motion.div variants={itemVariants} className="px-4 -mt-4 relative z-10">
              <div className="flex flex-wrap gap-3 bg-[#1a1a1a]/80 backdrop-blur-xl border border-white/10 p-4 rounded-xl shadow-2xl">
                <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
                  <p className={`text-[#ecab13] text-xl font-bold leading-tight ${cinzel.className}`}>99.8%</p>
                ...
                <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
                  <p className={`text-white text-xl font-bold leading-tight ${cinzel.className}`}>High</p>
                  <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider">Metalness</p>
                </div>
                <div className="w-px h-10 bg-white/10 self-center"></div>
                <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
                  <p className={`text-white text-xl font-bold leading-tight ${cinzel.className}`}>0.85</p>
            ...
            <motion.div variants={itemVariants} className="mt-12 px-4">
              ...
              <div className="flex gap-2 flex-wrap mb-8">
                <div className="flex h-8 items-center justify-center rounded-full border border-[#ecab13]/30 bg-[#ecab13]/10 px-4 transition-colors hover:bg-[#ecab13]/20">
                  <p className="text-[#ecab13] text-[11px] font-bold uppercase tracking-wider">Brushed Aluminum Finish</p>
                </div>
                <div className="flex h-8 items-center justify-center rounded-full border border-white/10 bg-white/5 px-4 transition-colors hover:bg-white/10">
            ...
            <motion.div variants={itemVariants} className="mb-12">
              ...
              <div className="flex gap-4 overflow-x-auto px-4 no-scrollbar pb-2 snap-x">
                <div
                  className="min-w-[160px] aspect-square rounded-lg bg-zinc-800 bg-cover bg-center border border-white/10 saturate-[0.9] contrast-[1.1] snap-center hover:border-[#ecab13]/50 transition-colors"
            ...
            {/* Comparison Table */}
            <motion.div variants={itemVariants} className="px-4 py-6 bg-white/5 border-y border-white/10 mb-8">
              <div className="flex justify-between items-center py-3">
                <span className="text-zinc-500 text-xs uppercase tracking-widest">Weight</span>
                <span className="text-white text-sm font-medium">240 GSM</span>
              </div>
              <div className="flex justify-between items-center py-3 border-t border-white/5">
                ...
                <span className="text-white text-sm font-medium">70% Silk, 30% Metallic Alloy</span>
              </div>
              <div className="flex justify-between items-center py-3 border-t border-white/5">
                <span className="text-zinc-500 text-xs uppercase tracking-widest">Physics Mesh</span>
                <span className="text-white text-sm font-medium">12,400 Polygons</span>
              </div>
            </motion.div>
          </motion.div>
        </main>
        ...
        <motion.div
          ...
          className="fixed bottom-0 w-full p-4 pb-8 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-white/10 flex gap-4 items-center z-50"
        >
          <div className="flex flex-col flex-1">
            <span className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider">Starting at</span>
            <p className={`text-white text-xl font-bold ${cinzel.className}`}>$2,850</p>
          </div>
          <Link
            href="/luxury/fitting"
            className="flex-[2] bg-gradient-to-br from-[#ecab13] to-[#c48a0a] text-[#0a0a0a] h-14 rounded-xl flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(236,171,19,0.2)] hover:shadow-[0_0_30px_rgba(236,171,19,0.4)] active:scale-95 transition-all"
          >
