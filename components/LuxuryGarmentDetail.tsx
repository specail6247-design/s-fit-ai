...
export default function LuxuryGarmentDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-sans transition-colors duration-1000">
      <GoldRingCursor />

      {/* Top Navigation */}
      <div className={`fixed top-0 z-50 w-full bg-[#f8f7f6]/80 dark:bg-[#0a0a0a]/80 backdrop-blur-md transition-opacity duration-1000 ${isDigitalMirrorActive ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <div className="flex items-center p-4 justify-between max-w-md mx-auto">
          ...
          <h2 className="font-cinzel text-slate-900 dark:text-white text-sm font-bold tracking-[0.2em] uppercase flex-1 text-center">S_FIT AI</h2>
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        ...
        <motion.div
          className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900 saturate-[0.9] contrast-[1.1]"
        ...
        >
          ...
          {/* 3D UI Overlays */}
          <div className={`absolute bottom-6 left-4 right-4 flex justify-between items-end z-20 transition-opacity duration-1000 ${isDigitalMirrorActive ? 'opacity-0' : 'opacity-100'}`}>
            ...
            <div className="text-right">
              <p className="font-sans text-[#ecab13] text-[10px] font-bold tracking-widest uppercase mb-1">Authentic Render</p>
        ...
        <motion.div
          ...
          initial="hidden"
          animate={isDigitalMirrorActive ? "hidden" : "show"}
          className={`px-4 -mt-4 relative z-10 transition-opacity duration-1000 ${isDigitalMirrorActive ? 'pointer-events-none' : ''}`}
        >
        ...
        <motion.div variants={itemVariants} className="mt-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-cinzel text-white text-xs font-bold tracking-[0.2em] uppercase">Material Science</h2>
        ...
        <motion.div variants={itemVariants} className="mb-8">
          <div className="px-4 flex items-center justify-between mb-4">
            <h2 className="font-cinzel text-white text-xs font-bold tracking-[0.2em] uppercase">Detail Macro View</h2>
            <p className="font-sans text-zinc-500 text-xs">4K Textures</p>
          </div>
        ...
        {/* Comparison Table */}
        <motion.div variants={itemVariants} className="px-4 py-4 bg-[#1a1a1a]/30 border-y border-[#2d2d2d] mb-8 font-sans">
      ...
      {/* Bottom Action Bar */}
      <div className={`fixed bottom-0 w-full p-4 pb-8 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-[#2d2d2d] flex gap-4 items-center z-50 transition-opacity duration-1000 ${isDigitalMirrorActive ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        ...
        <motion.button
          ...
          className="flex-[2] bg-gradient-to-br from-[#ecab13] to-[#c48a0a] text-[#0a0a0a] h-14 rounded-xl flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(236,171,19,0.3)] transition-transform"
        >
