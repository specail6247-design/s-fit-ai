...
export default function LuxuryGarmentDetail() {
  return (
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-space">
      {/* Top Navigation */}
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        ...
        {/* Material Science Description - Staggered Reveal */}
        <motion.div
          className="mt-8 px-4"
        ...
        >
          ...
          <motion.p className="text-zinc-400 text-sm leading-relaxed mb-6 font-space" variants={itemVariants}>
          ...
          {/* Chips */}
          <motion.div className="flex gap-2 flex-wrap mb-8" variants={itemVariants}>
