    ...
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-sans">
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
          ...
          <div className="absolute bottom-6 left-4 right-4 flex justify-between items-end">
            ...
            <div className="text-right">
              <motion.p
                ...
                className="text-[#ecab13] text-[10px] font-bold tracking-widest uppercase mb-1 font-space"
              >
                Authentic Render
              </motion.p>
              <motion.h1
        ...
        >
          ...
          <motion.div variants={itemVariants} className="px-4 -mt-4 relative z-10">
            <div className="flex flex-wrap gap-3 bg-[#1a1a1a]/60 backdrop-blur-xl border border-[#2d2d2d] p-4 rounded-xl">
              <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
                <p className="text-[#ecab13] text-xl font-bold leading-tight font-space">99.8%</p>
                <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider font-space">Realism</p>
              </div>
              <div className="w-px h-10 bg-[#2d2d2d] self-center"></div>
              <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
                <p className="text-white text-xl font-bold leading-tight font-space">High</p>
                <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider font-space">Metalness</p>
              </div>
              <div className="w-px h-10 bg-[#2d2d2d] self-center"></div>
              <div className="flex min-w-[80px] flex-1 flex-col gap-1 items-center text-center">
                <p className="text-white text-xl font-bold leading-tight font-space">0.85</p>
                <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider font-space">Clearcoat</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-8 px-4">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-6 font-space">
            ...
            <div className="flex gap-2 flex-wrap mb-8">
              <div className="flex h-8 items-center justify-center rounded-full border border-[#ecab13]/30 bg-[#ecab13]/10 px-4">
                <p className="text-[#ecab13] text-[11px] font-bold uppercase tracking-wider font-space">Brushed Aluminum Finish</p>
              </div>
              <div className="flex h-8 items-center justify-center rounded-full border border-[#2d2d2d] bg-[#1a1a1a] px-4">
                <p className="text-zinc-300 text-[11px] font-bold uppercase tracking-wider font-space">Clearcoat Tech</p>
              </div>
              <div className="flex h-8 items-center justify-center rounded-full border border-[#2d2d2d] bg-[#1a1a1a] px-4">
                <p className="text-zinc-300 text-[11px] font-bold uppercase tracking-wider font-space">Silk Blend</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <div className="px-4 flex items-center justify-between mb-4">
              ...
              <p className="text-zinc-500 text-xs font-space">4K Textures</p>
            </div>
          ...
          <motion.div variants={itemVariants} className="px-4 py-4 bg-[#1a1a1a]/30 border-y border-[#2d2d2d] mb-8">
            <div className="flex justify-between items-center py-2">
              <span className="text-zinc-500 text-xs uppercase tracking-widest font-space">Weight</span>
              <span className="text-white text-sm font-space">240 GSM</span>
            </div>
            <div className="flex justify-between items-center py-2 border-t border-[#2d2d2d]/50">
              <span className="text-zinc-500 text-xs uppercase tracking-widest font-space">Composition</span>
              <span className="text-white text-sm font-space">70% Silk, 30% Metallic Alloy</span>
            </div>
            <div className="flex justify-between items-center py-2 border-t border-[#2d2d2d]/50">
              <span className="text-zinc-500 text-xs uppercase tracking-widest font-space">Physics Mesh</span>
              <span className="text-white text-sm font-space">12,400 Polygons</span>
            </div>
          </motion.div>
        </motion.div>
      </main>
      ...
      >
        <div className="flex flex-col flex-1">
          <span className="text-zinc-500 text-[10px] font-bold uppercase tracking-wider font-space">Starting at</span>
          <p className="text-white text-xl font-bold font-space">$2,850</p>
        </div>
        <Link href="/luxury/fitting" className="flex-[2] bg-gradient-to-br from-[#ecab13] to-[#c48a0a] text-[#0a0a0a] h-14 rounded-xl flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(236,171,19,0.3)] hover:scale-[1.02] transition-transform">
          ...
          <span className="font-bold text-sm tracking-widest uppercase font-cinzel">Try on Mannequin</span>
        </Link>
      </motion.div>
