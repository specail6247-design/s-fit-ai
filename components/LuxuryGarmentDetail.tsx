      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        ...
        <div className="mt-8 px-4">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed mb-6">
            Engineered with S_FIT AI\S_FIT AI&apos;sapos;s proprietary light-refraction engine. This fabric blends high-twist Italian silk with microscopic aluminum particles, creating a finish that flows like liquid metal under studio lighting.
          </p>
