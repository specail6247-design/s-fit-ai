    ...
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-sans">
        ...
        <div className="flex items-center p-4 justify-between max-w-md mx-auto">
          ...
          <div className="flex gap-2 items-center justify-end">
            ...
            <button
              ...
              className={`flex size-10 items-center justify-center rounded-full bg-white/10 text-white hover:bg-white/20 transition-colors ${isSaved ? 'text-[#ecab13]' : ''}`}
            >
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        ...
        <div className="px-4 mb-8">
          <div className="bg-[#1a1a1a]/40 border border-[#ecab13]/20 rounded-xl p-4 flex gap-4">
      ...
      <div className="fixed bottom-0 w-full p-4 pb-8 bg-[#0a0a0a]/90 backdrop-blur-xl border-t border-[#2d2d2d] flex gap-4 items-center z-50">
        ...
        {timeLeft > 0 ? (
          <button disabled className="flex-[2] bg-zinc-800 text-zinc-500 h-14 rounded-xl flex items-center justify-center gap-3 opacity-50 cursor-not-allowed">
      ...
      {/* The Vault Drawer */}
      {isVaultOpen && (
        <div className="fixed inset-0 z-[100] flex items-end justify-center sm:items-center bg-black/60 backdrop-blur-sm" onClick={() => setIsVaultOpen(false)}>
          <div
            className="w-full max-w-md bg-[#1a1a1a] border border-[#2d2d2d] rounded-t-2xl sm:rounded-2xl p-6 shadow-2xl"
          ...
          >
            <div className="flex justify-between items-center mb-6 border-b border-[#2d2d2d] pb-4">
              ...
              <button onClick={() => setIsVaultOpen(false)} className="text-zinc-500 hover:text-white"><span className="material-symbols-outlined">close</span></button>
            </div>

            {isSaved ? (
              <div className="flex items-center gap-4 p-4 rounded-xl border border-[#2d2d2d] bg-[#0a0a0a] hover:border-[#ecab13]/50 transition-colors cursor-pointer">
                <div className="w-16 h-16 rounded-md bg-zinc-800 bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuC5m1trvvOgtFQZrHz7J1_8YKjIyJFwuTm6b_C9mQJtDJDsOl_xtHZHfLA3MDVgFSQv4zos6OnEPUwen36ZcXZRERoj4Bj3o87kdcXjQWJ8YNc33SLIAqJUET6o0yOwx_pVzx0OswcPQw2ivo6sLma8xEumxoFQDfDsbpY-obuXwXx9h6QOzOhEDJvrFuPoRkbJEz-kJUE5bbVxawyJiFfEmGOi47n8Jrh8-zVHq14XQL_snfcQ2Ia117Mk5S2bn_rRht21zxTm58E")' }} />
                <div className="flex-1">
                  <p className="text-white text-sm font-bold">Metallic Silk Evening Blazer</p>
                  <p className="text-[#ecab13] text-xs font-bold tracking-widest uppercase mt-1">$2,850</p>
                </div>
              </div>
            ) : (
              <div className="py-8 text-center">
                <span className="material-symbols-outlined text-4xl text-zinc-600 mb-2">inventory_2</span>
