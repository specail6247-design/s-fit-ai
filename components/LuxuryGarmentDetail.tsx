...
export default function LuxuryGarmentDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f6] dark:bg-[#0a0a0a] text-slate-900 dark:text-white font-space-grotesk">
      {/* Top Navigation */}
      ...
      <main className="max-w-md mx-auto pt-16 pb-32">
        {/* 3D Interactive Viewport (Hero Image with Distortion) */}
        <div className="relative w-full aspect-[3/4] overflow-hidden bg-zinc-900 luxury-grade">
            <LuxuryImageDistortion imageSrc="https://lh3.googleusercontent.com/aida-public/AB6AXuC5m1trvvOgtFQZrHz7J1_8YKjIyJFwuTm6b_C9mQJtDJDsOl_xtHZHfLA3MDVgFSQv4zos6OnEPUwen36ZcXZRERoj4Bj3o87kdcXjQWJ8YNc33SLIAqJUET6o0yOwx_pVzx0OswcPQw2ivo6sLma8xEumxoFQDfDsbpY-obuXwXx9h6QOzOhEDJvrFuPoRkbJEz-kJUE5bbVxawyJiFfEmGOi47n8Jrh8-zVHq14XQL_snfcQ2Ia117Mk5S2bn_rRht21zxTm58E" />
          ...
          <div className="absolute bottom-6 left-4 right-4 flex justify-between items-end pointer-events-none">
            ...
            >
              <p className="text-[#ecab13] text-[10px] font-bold tracking-widest uppercase mb-1 font-cinzel">Authentic Render</p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <motion.div variants={itemVars} className="flex flex-wrap gap-3 bg-[#1a1a1a]/60 backdrop-blur-xl border border-[#2d2d2d] p-4 rounded-xl">
        ...
        >
          ...
          <motion.p variants={itemVars} className="text-zinc-400 text-sm leading-relaxed mb-6">
          ...
          {/* Chips */}
          <motion.div variants={itemVars} className="flex gap-2 flex-wrap mb-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <motion.div variants={itemVars} className="px-4 flex items-center justify-between mb-4">
          ...
          <motion.div variants={itemVars} className="flex gap-4 overflow-x-auto px-4 no-scrollbar pb-2">
            <div 
