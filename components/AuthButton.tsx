    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-void-black border border-white/10 w-full max-w-sm rounded-2xl p-8 relative shadow-premium">
            <button
            ...
            <h2 className="text-2xl font-black text-white mb-8 text-center uppercase tracking-widest font-mono">
              {isLogin ? 'VIP MEMBER ACCESS' : 'JOIN THE CLUB'}
            </h2>
            ...
            <form onSubmit={handleAuth} className="space-y-4 mb-6">
              <input
                ...
                className="w-full bg-transparent border-b border-white/20 px-0 py-3 text-white text-sm focus:border-white outline-none transition-colors mb-4"
                required
              />
              <input
                type="password"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-white text-void-black font-black py-4 mt-4 rounded-none hover:bg-gray-200 transition-colors disabled:opacity-50 tracking-widest uppercase"
              >
