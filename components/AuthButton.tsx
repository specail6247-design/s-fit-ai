  ...
  return (
    <>
      <button
        ...
        className="bg-cyber-lime text-void-black px-5 py-2 rounded-full text-xs font-bold hover:brightness-110 transition-all uppercase font-serif tracking-widest"
      >
        Member Access
      </button>

      <MemberAccessModal isOpen={showModal} onClose={() => setShowModal(false)} />
    </>
  );
}
