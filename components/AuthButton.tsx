  ...
  return (
    <>
      <button
        ...
        className="bg-white/10 text-white px-6 py-2.5 rounded-full text-xs font-bold hover:bg-white/20 transition-all tracking-widest uppercase border border-white/20"
      >
        MEMBER ACCESS
      </button>
