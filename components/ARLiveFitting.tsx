        ...
        <div className="mt-auto pb-10 z-10">
          ...
          <div className="flex items-center justify-center gap-10 p-4">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <button aria-label="Take photo" className="relative flex size-20 shrink-0 items-center justify-center rounded-full border-4 border-[#2b8cee] bg-white focus-visible:ring-2 focus-visible:ring-[#2b8cee] outline-none">
            ...
            <button aria-label="Retake photo" className="flex size-12 shrink-0 items-center justify-center rounded-full text-white focus-visible:ring-2 focus-visible:ring-white outline-none" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
