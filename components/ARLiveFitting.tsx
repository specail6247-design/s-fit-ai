        ...
        <div className="mt-auto pb-10 z-10">
          ...
          <div className="flex overflow-x-auto px-2 py-4 scrollbar-hide" style={{ maskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)" }}>
            <div className="flex items-stretch gap-3">
              ...
              <div className="flex min-w-28 flex-col gap-2 rounded-xl p-1 opacity-60 relative overflow-hidden" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
                <div
                  className="aspect-[4/5] w-full rounded-lg bg-cover bg-center bg-no-repeat"
                  style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBDuZWxVmd1NmjEA78u9Bug9IALerv3mXMc1jJvFfkpQU0KEpj8H61ezGs7q-hQ_LQRxtHc4H_QAcTqOu2tETfyqrqqB-aXKc3It-W2CEa6sQYIBEuVrJ3bD5_XTaA0GeVrfvnDnypd9so862LZS33A3sTJ-U845P-JhNQnT3cFcg8qcI-I8oVMkmM7fFRmlKYyMl1ej6WWWa3MkChOC6VmkauVlN4Z8jsBZoMcEUD9yXSwQ97ZkmgJJj2A6eIHMvudiZqjCSTgWh0")', filter: 'grayscale(100%) brightness(0.5)' }}
                ></div>
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none mt-[-20px]">
                  <span className="material-symbols-outlined text-white mb-1">lock</span>
                  <p className="text-[9px] font-bold uppercase tracking-widest text-white/80">Available In</p>
                  <p className="text-[11px] font-bold text-white">02:00:00</p>
                </div>
                <div className="px-1 pb-1">
                  <p className="truncate text-[10px] font-bold uppercase text-white">Quantum Trench</p>
                  <p className="text-[10px] font-bold text-white/50">Exclusive Drop</p>
                </div>
              </div>
