    ...
    <div className={`relative flex h-screen w-full flex-col overflow-hidden bg-[#f6f7f8] text-white dark:bg-[#101922] ${spaceGrotesk.className}`}>
      ...
      >
        ...
        <div className="z-10 flex items-center justify-between p-4 pt-8">
          <button aria-label="Close" className="flex size-12 items-center justify-center rounded-full focus-visible:ring-2 outline-none focus-visible:ring-[#2b8cee]" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
          ...
          <button aria-label="Toggle flash" className="flex size-12 items-center justify-center rounded-full focus-visible:ring-2 outline-none focus-visible:ring-[#2b8cee]" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
        ...
        <div className="mt-auto pb-10 z-10">
          ...
          <div className="flex items-center justify-center gap-10 p-4">
            <button aria-label="Open photo library" className="flex size-12 shrink-0 items-center justify-center rounded-full text-white focus-visible:ring-2 outline-none focus-visible:ring-[#2b8cee]" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
              <span className="material-symbols-outlined">photo_library</span>
            </button>
            <div className="relative flex items-center justify-center">
              <div className="absolute inset-0 animate-pulse rounded-full bg-[#2b8cee]/30 blur-xl"></div>
              <button aria-label="Take Fit Snap" className="relative flex size-20 shrink-0 items-center justify-center rounded-full border-4 border-[#2b8cee] bg-white focus-visible:ring-2 outline-none focus-visible:ring-[#2b8cee] focus-visible:ring-offset-2 focus-visible:ring-offset-[#101922]">
            ...
            <button aria-label="Refresh fit" className="flex size-12 shrink-0 items-center justify-center rounded-full text-white focus-visible:ring-2 outline-none focus-visible:ring-[#2b8cee]" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
