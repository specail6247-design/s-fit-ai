    ...
    <div className={`relative flex h-screen w-full flex-col overflow-hidden bg-[#f6f7f8] text-white dark:bg-[#101922] ${spaceGrotesk.className}`}>
      ...
      >
        ...
        <div className="z-10 flex items-center justify-between p-4 pt-8">
          <button aria-label="Close" className="flex size-12 items-center justify-center rounded-full cursor-pointer" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
          ...
          <button aria-label="Toggle flash" className="flex size-12 items-center justify-center rounded-full cursor-pointer" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
        ...
        <div className="absolute right-4 top-1/4 z-10 flex flex-col gap-3">
          ...
          <div className="flex min-w-[120px] flex-col gap-1 rounded-lg p-3" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
            ...
            <div className="flex items-baseline gap-1">
              ...
              <span className="material-symbols-outlined text-[14px] text-[#2b8cee]" aria-hidden="true">verified</span>
            </div>
          </div>
        </div>
