      ...
      >
        ...
        <div className="mt-auto pb-10 z-10">
          ...
          <div className="flex items-center justify-center gap-10 p-4">
            <button aria-label="Open photo library" className="flex size-12 shrink-0 items-center justify-center rounded-full text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2b8cee]" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
              <span aria-hidden="true" className="material-symbols-outlined">photo_library</span>
            </button>
            <div className="relative flex items-center justify-center">
              <div className="absolute inset-0 animate-pulse rounded-full bg-[#2b8cee]/30 blur-xl"></div>
              <button aria-label="Take fit snap" className="relative flex size-20 shrink-0 items-center justify-center rounded-full border-4 border-[#2b8cee] bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2b8cee]">
                <div className="flex size-16 items-center justify-center rounded-full border-2 border-[#101922]/10">
                  <span aria-hidden="true" className="material-symbols-outlined text-4xl text-[#101922]">camera</span>
                </div>
              </button>
            ...
            <button aria-label="Switch camera" className="flex size-12 shrink-0 items-center justify-center rounded-full text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2b8cee]" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
