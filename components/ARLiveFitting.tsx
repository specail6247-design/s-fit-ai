    ...
    <div className={`relative flex h-screen w-full flex-col overflow-hidden bg-[#f6f7f8] text-white dark:bg-[#101922] ${spaceGrotesk.className}`}>
      ...
      >
        ...
        <div className="z-10 flex items-center justify-between p-4 pt-8">
          <button aria-label="Close live fitting" className="flex size-12 items-center justify-center rounded-full" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
          ...
          <div className="flex items-center justify-center gap-10 p-4">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute -bottom-6 flex flex-col items-center">
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#2b8cee]" aria-hidden="true">Fit Snap</span>
              </div>
            </div>
            <button aria-label="Refresh fit" className="flex size-12 shrink-0 items-center justify-center rounded-full text-white" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
