        ...
        <div className="z-10 flex items-center justify-between p-4 pt-8">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex size-12 items-center justify-center rounded-full hover:bg-white/20 transition-colors"
          ...
          <div className="flex overflow-x-auto px-2 py-4 scrollbar-hide" style={{ maskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)" }}>
            <div className="flex items-stretch gap-3">
              ...
              {[
                ...
                <div key={i} className={`flex min-w-28 flex-col gap-2 rounded-xl p-1 ${item.locked ? 'opacity-50 grayscale' : 'opacity-80'}`} style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
                    <div
                    ...
                    {item.locked ? (
                      <p className="text-[10px] font-mono text-[#ecab13]">{formatTime(timeLeft)}</p>
                    ) : (
