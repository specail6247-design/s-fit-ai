        ...
        <div className="mt-auto pb-10 z-10">
          ...
          <div className="flex items-center justify-center gap-10 p-4">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <button aria-label="Take Fit Snap photo" className="relative flex size-20 shrink-0 items-center justify-center rounded-full border-4 border-[#2b8cee] bg-white">
            ...
            <button aria-label="Refresh capture view" className="flex size-12 shrink-0 items-center justify-center rounded-full text-white" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
