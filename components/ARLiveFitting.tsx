              ...
              {luxuryItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex min-w-28 flex-col gap-2 rounded-xl p-1 transition-all duration-300 ${
                      isSelected
                        ? "border-2 border-[#2b8cee] bg-[#2b8cee]/20 backdrop-blur-md scale-105 luxury-shimmer"
                        : "opacity-80 border border-white/10 bg-[#101922]/60 backdrop-blur-md hover:opacity-100"
                    }`}
                  >
                    <div className="relative aspect-[4/5] w-full overflow-hidden rounded-lg bg-black/20">
                      <Image
                        ...
                        onError={(e) => {
                          ...
                          target.srcset = "https://placehold.co/400x500/1a1a1a/ffffff?text=No+Image";
                          target.src = "https://placehold.co/400x500/1a1a1a/ffffff?text=No+Image";
                        }}
                      />
                    </div>
                    <div className="w-full px-1 pb-1 text-left">
