    ...
    try {
      if (navigator.share) {
        await navigator.share({
          ...
          text: 'Check out my cinematic 4K try-on video from S_FIT AI!',
          url: videoUrl,
        });
      } else {
        ...
        a.href = videoUrl;
        a.download = 'sfit-cinematic-tryon.mp4';
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handleShare}
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#C9B037] to-[#F4E4BC] text-black hover:opacity-90 rounded-full text-sm font-bold tracking-wide transition-all shadow-lg transform hover:scale-105"
