      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-[var(--color-background)]">
        ...
        <div className="absolute inset-0 bg-black/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-focus-within:opacity-100 flex items-center justify-center">
          <motion.button
            ...
            className="rounded-full bg-[var(--color-surface)] px-6 py-2 text-sm font-semibold text-[var(--color-secondary)] hover:bg-[var(--color-primary)] focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] transition-colors shadow-lg"
