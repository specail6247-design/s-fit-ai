    ...
    <div className="w-full h-full flex flex-col bg-void-black text-pure-white">
      <div className="flex-1 relative min-h-[350px]">
        ...
        <div className="absolute top-4 left-4 flex gap-2 z-20">
            <button aria-label="Share outfit" onClick={() => setShowShareModal(true)} className="bg-charcoal/60 backdrop-blur-md p-2 rounded-xl border border-white/10 hover:bg-charcoal/80 transition-colors">
                <span>📤</span>
            </button>
