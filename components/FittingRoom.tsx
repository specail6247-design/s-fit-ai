...
function Mannequin({ 
  ...
  return (
    <group scale={[scale, scale, scale]}>
      {/* Generic RPM Avatar Buffer - Using Xbot as reliable fallback */}
      <AvatarLoader 
...
function ItemCard({
  ...
  return (
    ...
    >
      ...
      <div className="aspect-square rounded-md mb-2 flex items-center justify-center relative overflow-hidden bg-white/5" style={{ backgroundColor: imageError ? primaryColor : 'transparent' }}>
        {!imageError ? (
           <Image
             src={item.imageUrl}
             alt={item.name}
