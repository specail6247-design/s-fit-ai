    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-void-black/80 backdrop-blur-md p-4">
            <div className="glass-card p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                    <div>
                        <h3 className="text-xl font-bold text-pure-white flex items-center gap-2 font-cinzel"><span className="animate-pulse">✨</span> Masterpiece Try-On</h3>
...
export function FittingRoom() {
  ...
  const uiOpacityClass = aiTryOnLoading ? 'opacity-0 pointer-events-none transition-opacity duration-1000' : 'opacity-100 transition-opacity duration-500';
                ...
                >
                  <div className="relative w-[70%] h-[50%]">
                    <Image
                      ...
                      fill
                      className="object-contain drop-shadow-2xl editorial-filter"
            ...
            <div className="absolute top-16 left-1/2 -translate-x-1/2 w-[90%] max-w-md z-20">
              {isMiniBarCollapsed ? (
                <div className="glass-card px-3 py-2 flex items-center justify-between gap-3">
                  <span className="text-[0.55rem] uppercase tracking-[0.2em] text-soft-gray font-cinzel">AI Picks</span>
                  ...
                  {currentItem && poseAnalysis?.proportions && recommendedFit && (
                      ...
                      >
                          <div className="flex items-center gap-3 mb-2">
                              ...
                              <div>
                                  <p className="text-[10px] uppercase tracking-widest text-soft-gray font-bold font-cinzel">AI Recommended Fit</p>
      ...
      <div className={uiOpacityClass}>
        ...
        <div className="p-4 border-t border-border-color bg-void-black">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-[10px] uppercase tracking-widest text-soft-gray font-cinzel">{selectedBrand} Collection</h3>
          ...
          <div className="p-4 bg-charcoal/30 border-t border-border-color">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold uppercase tracking-wider text-cyber-lime font-cinzel">AI Stylist&apos;s Choice</span>
              </div>
