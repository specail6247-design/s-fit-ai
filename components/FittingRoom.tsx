...
function ItemCard({
  ...
  return (
    ...
    >
      ...
      <div className="aspect-square rounded-md mb-2 flex items-center justify-center relative overflow-hidden bg-charcoal z-10">
        {!imageError ? (
           <Image
             src={item.imageUrl}
             alt={item.name}
      ...
      <p className="relative z-10 text-[0.6rem] text-pure-white truncate">{item.name}</p>
      <p className="relative z-10 text-[0.55rem] text-soft-gray">${item.price}</p>
      <p className="relative z-10 text-[0.55rem] text-cyber-lime">Fit {fitScore}%</p>
    </motion.button>
  );
}
