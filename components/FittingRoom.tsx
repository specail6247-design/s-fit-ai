    ...
    <motion.div className="fixed inset-0 z-50 flex items-center justify-center p-4" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <motion.div className="relative glass-card p-6 max-w-md w-full max-h-[80vh] overflow-y-auto" initial={{ scale: 0.9, y: 20 }} animate={{ scale: 1, y: 0 }}>
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={onClose} aria-label="Close compare modal" className="text-soft-gray hover:text-white">✕</button>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-void-black/80 backdrop-blur-md p-4">
            <div className="glass-card p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button onClick={onClose} aria-label="Close AI try-on modal" className="text-soft-gray hover:text-white text-2xl">✕</button>
                </div>
    ...
    <div className="w-full h-full flex flex-col bg-void-black text-pure-white">
      <div className="flex-1 relative min-h-[350px]">
        ...
        <div className="absolute top-4 left-4 flex gap-2 z-20">
            <button onClick={() => setShowShareModal(true)} aria-label="Share fitting result" className="bg-charcoal/60 backdrop-blur-md p-2 rounded-xl border border-white/10 hover:bg-charcoal/80 transition-colors">
                <span>📤</span>
            </button>
          ...
          <div className="absolute top-16 left-1/2 -translate-x-1/2 w-[90%] max-w-md z-20">
            {isMiniBarCollapsed ? (
              ...
              <div className="glass-card px-3 py-2 flex items-center gap-2 relative overflow-hidden">
                 ...
                 <button onClick={() => setMiniBarCollapsed(true)} aria-label="Close AI picks mini bar" className="text-[0.55rem] text-soft-gray ml-1">✕</button>
