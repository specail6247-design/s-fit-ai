...
function ItemCard({
  ...
  return (
    ...
    >
      ...
      {isSelected && (
        <motion.div
          className="absolute inset-0 z-0 bg-gradient-to-tr from-transparent via-white/10 to-transparent skew-x-12"
          initial={{ x: '-150%' }}
          animate={{ x: '150%' }}
      ...
      <div className="aspect-square rounded-md mb-2 flex items-center justify-center relative overflow-hidden bg-charcoal/50 z-10">
        {!imgError ? (
          <Image
            src={item.imageUrl}
            alt={item.name}
