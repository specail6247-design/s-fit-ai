  ...
  return (
    <div className={`relative flex h-screen w-full flex-col overflow-hidden bg-[#f5f6f8] text-white dark:bg-[#101622] ${spaceGrotesk.className}`}>
      ...
      <div className="z-50 flex items-center justify-between bg-transparent p-4">
        <button aria-label="Go back" className="flex size-12 shrink-0 cursor-pointer items-center justify-center rounded-full bg-[#101622]/40 text-white backdrop-blur-md transition-colors hover:bg-[#101622]/60 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#256af4]">
        ...
        <div className="flex w-12 items-center justify-end">
          <button aria-label="Information" className="flex size-12 cursor-pointer items-center justify-center rounded-full bg-[#101622]/40 text-white backdrop-blur-md transition-colors hover:bg-[#101622]/60 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#256af4]">
