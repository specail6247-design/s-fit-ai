  ...
  return (
    <div className={`relative flex h-screen w-full flex-col overflow-hidden bg-[#f5f6f8] text-white dark:bg-[#101622] ${spaceGrotesk.className}`}>
      ...
      <div className="z-50 flex items-center justify-between bg-transparent p-4">
        <button aria-label="Go back" className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#101622]/40 text-white backdrop-blur-md focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#101622] outline-none">
        ...
        <div className="flex w-12 items-center justify-end">
          <button aria-label="Info" className="flex size-12 cursor-pointer items-center justify-center rounded-full bg-[#101622]/40 text-white backdrop-blur-md focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[#101622] outline-none">
