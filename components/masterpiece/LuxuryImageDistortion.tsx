  ...
  return (
    <div className={`relative w-full h-full overflow-hidden ${className}`}>
      <Canvas orthographic camera={{ position: [0, 0, 1], zoom: 1 }}>
        <React.Suspense fallback={<div className="absolute inset-0 flex items-center justify-center bg-black"><div className="w-64 h-64 border border-[#C9B037]/20 relative"><motion.div className="absolute top-0 left-0 h-[1px] bg-[#C9B037]" animate={{ width: ["0%", "100%", "100%", "0%"], left: ["0%", "0%", "100%", "100%"] }} transition={{ duration: 2, repeat: Infinity, ease: "linear" }} /><motion.div className="absolute top-0 right-0 w-[1px] bg-[#C9B037]" animate={{ height: ["0%", "100%", "100%", "0%"], top: ["0%", "0%", "100%", "100%"] }} transition={{ duration: 2, repeat: Infinity, ease: "linear", delay: 0.5 }} /><motion.div className="absolute bottom-0 right-0 h-[1px] bg-[#C9B037]" animate={{ width: ["0%", "100%", "100%", "0%"], right: ["0%", "0%", "100%", "100%"] }} transition={{ duration: 2, repeat: Infinity, ease: "linear", delay: 1 }} /><motion.div className="absolute bottom-0 left-0 w-[1px] bg-[#C9B037]" animate={{ height: ["0%", "100%", "100%", "0%"], bottom: ["0%", "0%", "100%", "100%"] }} transition={{ duration: 2, repeat: Infinity, ease: "linear", delay: 1.5 }} /></div></div>}>
