      ...
      {modes.map((mode, index) => (
        ...
        >
          ...
          <div className="w-full">
            <span className="block text-center w-full py-4 border-t border-white/10 text-xs font-bold uppercase tracking-widest text-soft-gray group-hover:bg-white group-hover:text-void-black transition-all duration-300">
              Select Mode_
            </span>
          </div>
