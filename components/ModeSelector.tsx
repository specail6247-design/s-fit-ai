    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto w-full px-4">
      {modes.map((mode, index) => (
        <motion.button
          ...
          className="mode-card group w-full relative flex flex-col items-center text-center h-[400px] justify-between focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyber-lime cursor-pointer"
