...
export default function LuxuryLiveFitting() {
  return (
    <div className={`relative flex h-screen w-full flex-col overflow-hidden duration-1000 ease-in-out cursor-[url(/cursor-ring.svg)_16_16,auto] bg-[#faf9f6] text-white dark:bg-black ${playfair.className}`}>
      ...
      >
        ...
        <div className="z-10 flex items-center justify-between p-6 pt-12">
          ...
          <div className="flex items-center gap-6 rounded-full px-4 py-2" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
            <div className="relative size-4 flex items-center justify-center"><div className="absolute inset-0 border border-[#d4af37] animate-[spin_3s_linear_infinite]" /><div className="size-1 bg-[#d4af37] rounded-full" /></div>
            <h2 className="text-sm font-bold tracking-[0.2em] uppercase text-white/90">LUXURY LIVE FIT</h2>
          </div>
          <div className="flex size-12 items-center justify-center rounded-full" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
        ...
        <div className="mt-4 space-y-4 px-4 z-10">
          <div className="max-w-[240px] rounded-xl p-6" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
            <div className="flex flex-col gap-6">
              ...
              <div className="h-1.5 w-full overflow-hidden duration-1000 ease-in-out cursor-[url(/cursor-ring.svg)_16_16,auto] rounded-full bg-white/10">
        ...
        <div className="absolute right-4 top-1/4 z-10 flex flex-col gap-6">
        ...
        <div className="mt-auto pb-10 z-10">
          {/* Garment Carousel */}
          <div className="flex overflow-x-auto px-8 py-8 scrollbar-hide space-x-8" style={{ maskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)" }}>
            <div className="flex items-end gap-8">
              <div className="flex w-48 flex-col gap-4 rounded-none border border-[#d4af37]/50 bg-black/40 p-3 backdrop-blur-md">
                ...
                <div className="px-1 pb-1">
                  ...
                  <p className="text-[10px] font-bold text-[#d4af37]">$2,400</p>
                </div>
              </div>
              ...
              {[
                ...
                <div key={i} className="flex w-40 flex-col gap-4 rounded-none p-2 opacity-80" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
          ...
          <div className="flex items-center justify-center gap-10 p-6">
            ...
            <div className="relative flex items-center justify-center">
              <div className="absolute inset-0 animate-pulse duration-1000 rounded-full bg-[#d4af37]/30 blur-xl"></div>
