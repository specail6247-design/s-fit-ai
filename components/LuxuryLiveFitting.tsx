  ...
  return (
    <div className={`relative flex h-screen w-full flex-col overflow-hidden bg-[#f6f7f8] text-white dark:bg-[#101922] ${playfair.className}`}>
      ...
      <div className="relative flex h-screen w-full flex-col" data-alt="User reflection with AR garment overlay">
        ...
        <div className="absolute top-20 left-0 w-full flex justify-center z-0 opacity-20 pointer-events-none">
           <div className="text-[120px] font-bold tracking-[0.2em] text-white/10 uppercase" style={{ transform: 'translateY(20px)' }}>AURA</div>
        </div>
        {/* Top Navigation Bar */}
        <div className="z-10 flex items-center justify-between p-4 pt-8">
          ...
          <div className="flex items-center gap-2 rounded-full px-4 py-2" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
            <div className="size-3 animate-[spin_2s_linear_infinite] rounded-sm border border-transparent border-t-[#ecab13]"></div>
        ...
        <div className="mt-auto pb-10 z-10">
          {/* Garment Carousel */}
          <div className="flex flex-col gap-6 overflow-y-auto px-4 py-8 h-[50vh] scrollbar-hide" style={{ maskImage: "linear-gradient(to bottom, transparent, black 10%, black 90%, transparent)" }}>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-4 rounded-xl border-2 border-[#ecab13] bg-[#ecab13]/10 p-2 backdrop-blur-md transition-all duration-1000 scale-100">
                <div
              ...
              {[
                ...
                <div key={i} className="flex flex-col gap-4 rounded-xl p-2 opacity-60 hover:opacity-100 transition-all duration-1000" style={{ background: "rgba(16, 25, 34, 0.6)", backdropFilter: "blur(12px)", border: "1px solid rgba(255, 255, 255, 0.1)" }}>
                    <div
                    className="aspect-[4/5] w-full rounded-lg bg-cover bg-center bg-no-repeat"
