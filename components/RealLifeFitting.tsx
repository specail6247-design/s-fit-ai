...
export default function RealLifeFitting() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
      ...
      {/* LEFT PANEL: CONTROLS */}
      <motion.div animate={{ opacity: isProcessing ? 0 : 1 }} transition={{ duration: 1 }} className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        {/* Background Ambience */}
        ...
        >
          <motion.h1
            ...
            className="text-4xl font-black tracking-tighter font-[family-name:var(--font-cinzel)]"
          >
            S_FIT <span className="text-[#c9b037]">NEO</span>
          </motion.h1>
          <motion.p
            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
            className="text-xs text-gray-400 tracking-[0.3em] uppercase mt-2 font-[family-name:var(--font-space-grotesk)]"
          >
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="user-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  {userImage ? <img src={userImage} className="w-full h-full object-cover saturate-90 contrast-110" /> : <span className="text-2xl">👤</span>}
                </div>
                <div>
          ...
          <div className="space-y-2">
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="garment-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  {garmentImage ? <img src={garmentImage} className="w-full h-full object-cover saturate-90 contrast-110" /> : <span className="text-2xl">👕</span>}
                </div>
                <div>
        ...
        <div className="mt-8 relative z-10">
          {isProcessing ? (
            <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 z-[100] space-y-4">
              <div className="flex justify-between text-xs text-[#c9b037] font-mono">
                <span>ANALYZING...</span>
                <span>{progress}%</span>
              </div>
        ...
        {resultImage && !isProcessing && (
          ...
          >
            <div className="relative group">
              <LuxuryImageDistortion imageUrl={resultImage} className="w-full h-[70vh] rounded-xl shadow-2xl" />
              <button 
