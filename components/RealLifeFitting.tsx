        ...
        <div className="mt-8 relative z-10">
          {isProcessing ? (
            ...
            <button 
              ...
              className="w-full py-4 bg-[#007AFF] hover:bg-[#005bb5] text-white font-bold rounded-xl shadow-[0_0_20px_rgba(0,122,255,0.4)] transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#007AFF] outline-none"
            >
          ...
          >
            <div className="relative group">
              ...
              <button 
                ...
                className="absolute top-4 right-4 bg-black/60 text-white rounded-full p-2 hover:bg-[#007AFF] transition-colors focus-visible:ring-2 focus-visible:ring-white outline-none"
              >
