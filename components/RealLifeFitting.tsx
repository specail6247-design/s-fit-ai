...
export default function RealLifeFitting() {
  ...
  const [legalModalState, setLegalModalState] = useState<{isOpen: boolean, type: 'privacy' | 'terms'}>({isOpen: false, type: 'privacy'});
  ...
  const handleShareToStory = async () => {
    ...
    try {
      ...
      ctx.fillText('AI GENERATED FITTING', canvas.width / 2, canvas.height - 150);
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <header className="mb-10 relative z-10 flex justify-between items-start">
          ...
          <button
            ...
            className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 transition-colors text-white font-bold"
        ...
        <div className="space-y-8 relative z-10 flex-1 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            {/* Data Safety Badge */}
            <div className="flex items-center gap-2 mt-2 px-2 opacity-80">
      ...
      <SupportHub
        ...
        onOpenLegal={(type) => setLegalModalState({ isOpen: true, type })}
      />
      <LegalModal
