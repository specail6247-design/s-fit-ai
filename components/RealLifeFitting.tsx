        ...
        <header className="mb-10 relative z-10 flex justify-between items-start">
          ...
          <div className="flex gap-2">
            <button
                ...
                className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 hover:border-[#ecab13] transition-colors group bg-black/50 backdrop-blur-sm"
                title="Member Access"
            >
                <span className="material-symbols-outlined text-sm group-hover:text-[#ecab13]">person</span>
            </button>
            <button
                onClick={() => setSupportHubOpen(true)}
                className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 hover:border-blue-400 transition-colors group bg-black/50 backdrop-blur-sm"
                title="Support Hub"
            >
                <span className="material-symbols-outlined text-sm group-hover:text-blue-400">help</span>
            </button>
          </div>
        </header>
