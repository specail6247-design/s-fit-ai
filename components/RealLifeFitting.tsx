...
export default function RealLifeFitting() {
  ...
  const handleShareToStory = async () => {
    ...
    try {
      // Generate a branded vertical image using Canvas
      ...
      ctx.fillText('AI GENERATED FIT', canvas.width / 2, canvas.height - 150);
      ...
      canvas.toBlob(async (blob) => {
        ...
        if (navigator.share) {
          ...
          alert("Image downloaded! (Native sharing not supported on this device)");
        }
      }, 'image/png');
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="user-upload" className="cursor-pointer flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-green-400 mt-1 flex items-center gap-1"><span>🔒</span> Photos are processed securely and not shared.</div>
                </div>
              </label>
            </div>
          </div>
          ...
          >
            <div className="relative group">
              ...
              <button
                ...
                className="absolute bottom-4 right-4 bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] text-white px-4 py-2 rounded-xl text-xs font-bold shadow-lg hover:opacity-90 transition-opacity flex items-center gap-2"
              >
      ...
      <div className="fixed bottom-4 left-4 z-40 flex gap-4 text-xs text-gray-500">
        <button onClick={() => { setLegalType('privacy'); setLegalModalOpen(true); }} className="hover:text-white transition-colors">
          Privacy Policy
        </button>
        <button onClick={() => { setLegalType('terms'); setLegalModalOpen(true); }} className="hover:text-white transition-colors">
          Terms of Service
        </button>
      </div>
    </div>
