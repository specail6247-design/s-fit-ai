...
export default function RealLifeFitting() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
      ...
      {/* LEFT PANEL: CONTROLS */}
      <div
        className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative transition-opacity duration-500"
        style={{ opacity: isProcessing ? 0 : 1, pointerEvents: isProcessing ? 'none' : 'auto' }}
      >
        {/* Background Ambience */}
