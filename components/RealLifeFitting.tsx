        ...
        <header className="mb-10 relative z-10 flex justify-between items-start">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 hover:border-[#FFD700] hover:text-[#FFD700] transition-colors"
              title="Member Access"
            >
            ...
            <button
              ...
              className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10 hover:border-[#007AFF] hover:text-[#007AFF] transition-colors"
              title="Support Hub"
            >
