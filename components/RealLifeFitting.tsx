...
export default function RealLifeFitting() {
  ...
  const handleShareToStory = () => {
    ...
    // Set standard IG Story dimensions
    canvas.width = 1080;
    canvas.height = 1920;
    ...
    const img = new Image();
    img.crossOrigin = 'anonymous'; // Important for fetching external images securely
    img.onload = () => {
      ...
      ctx.fillText('VIRTUAL FITTING ROOM', canvas.width / 2, 220);

      // Small watermark at bottom
      ctx.font = '24px monospace';
      ctx.fillStyle = 'rgba(255, 255, 255, 0.5)';
      ctx.fillText('Generated by S_FIT AI • s-fit-ai.com', canvas.width / 2, canvas.height - 80);
      ...
      try {
        ...
        alert("Could not generate image due to cross-origin restrictions. Try right-clicking to save.");
      }
    };
          ...
          >
            <div className="relative group">
              ...
              <button
                ...
                className="absolute bottom-4 right-4 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white px-4 py-2 rounded-xl text-sm font-bold shadow-lg hover:scale-105 transition-transform flex items-center gap-2"
              >
