...
export default function RealLifeFitting() {
  ...
  const handleShareToStory = () => {
    ...
    img.onload = () => {
      ...
      ctx.fillText('MASTERPIECE FIT', canvas.width / 2, 120);

      ctx.fillStyle = '#007AFF';
      ctx.font = 'bold 30px monospace';
      ctx.fillText('AI GENERATED FITTING', canvas.width / 2, 170);
      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <div className="space-y-8 relative z-10 flex-1 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 mt-2 px-1 opacity-70">
              <span className="text-green-400 text-[10px]">🔒</span>
              <span className="text-[10px] font-mono text-gray-400">Photos are processed securely and not shared.</span>
            </div>
          </div>
        ...
        <div className="mt-8 relative z-10">
          ...
          <div className="mt-4 flex gap-4 justify-center items-center">
            <button onClick={() => setIsSupportModalOpen(true)} className="text-[10px] text-gray-500 hover:text-white uppercase tracking-widest transition-colors flex items-center gap-1">
              <span>🐛</span> Report Issue
            </button>
            <span className="text-gray-700">|</span>
            <button onClick={() => setIsLegalModalOpen(true)} className="text-[10px] text-gray-500 hover:text-white uppercase tracking-widest transition-colors flex items-center gap-1">
              <span>⚖️</span> Privacy & Terms
            </button>
          </div>
          ...
          >
            <div className="relative group">
              ...
              <button
                ...
                className="absolute bottom-4 right-4 bg-gradient-to-r from-purple-600 to-[#007AFF] text-white px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider hover:scale-105 transition-transform flex items-center gap-2 shadow-lg border border-white/20"
              >
