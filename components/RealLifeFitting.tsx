...
export default function RealLifeFitting() {
  ...
  const handleShareToStory = async () => {
    ...
    try {
      ...
      ctx.fillText('Try before you buy', canvas.width / 2, 220);
      ...
      canvas.toBlob(async (blob) => {
        ...
        if (navigator.share && navigator.canShare({ files: [file] })) {
          await navigator.share({
            ...
            text: 'Check out my new look on S_FIT NEO!'
          });
        } else {
          // Fallback: download
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <div className="space-y-8 relative z-10 flex-1 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="user-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10 relative">
                  {userImage ? <Image src={userImage} alt="User" fill unoptimized className="object-cover" /> : <span className="text-2xl">👤</span>}
                </div>
                <div>
            ...
            {/* Data Safety Badge */}
            <div className="flex items-center gap-2 mt-2 text-[10px] text-gray-400 bg-black/30 p-2 rounded-lg border border-white/5">
          ...
          <div className="space-y-2">
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="garment-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10 relative">
                  {garmentImage ? <Image src={garmentImage} alt="Garment" fill unoptimized className="object-cover" /> : <span className="text-2xl">👕</span>}
                </div>
                <div>
        ...
        <div className="mt-8 relative z-10">
          ...
          <div className="mt-8 flex justify-center gap-6 text-xs text-gray-500 font-medium">
      ...
      <div className="flex-1 relative bg-gradient-to-b from-[#0a0a0a] to-[#111]">
        ...
        {resultImage && !isProcessing && (
          ...
          >
            <div className="relative group h-[70vh] w-auto aspect-[3/4]">
              <Image src={resultImage} alt="Result" fill unoptimized className="rounded-xl object-contain shadow-2xl" />
              <button 
              ...
              <button
                ...
                className="absolute bottom-4 right-4 bg-[#007AFF] text-white px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-2 shadow-[0_0_15px_rgba(0,122,255,0.5)] hover:bg-[#005bb5] transition-colors"
              >
                📸 Share to Story
              </button>
            </div>
