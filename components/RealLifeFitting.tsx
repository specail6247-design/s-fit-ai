      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <header className="mb-10 relative z-10 flex justify-between items-start">
          ...
          <button
            ...
            className="text-xs text-white/50 hover:text-white transition-colors flex items-center gap-1 uppercase tracking-widest px-3 py-1 border border-white/10 rounded-full hover:bg-white/5"
          >
            <span>ℹ️</span> Support
          </button>
        </header>
