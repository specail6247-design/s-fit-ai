  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <header className="mb-10 relative z-10 flex justify-between items-start">
          ...
          <button
            ...
            className="text-[10px] font-bold text-[#D4AF37] border border-[#D4AF37]/30 px-3 py-1 rounded hover:bg-[#D4AF37] hover:text-black transition-all tracking-widest uppercase"
          >
            Member Access
          </button>
        </header>
      ...
      <button
        ...
        className="absolute bottom-8 right-8 z-50 w-12 h-12 bg-white/10 hover:bg-[#007AFF] text-white rounded-full backdrop-blur-md flex items-center justify-center shadow-lg transition-all hover:scale-110 group border border-white/10"
        aria-label="Open Support Hub"
      >
        <span className="text-xl font-bold">?</span>
        <span className="absolute right-full mr-4 bg-black/80 px-2 py-1 rounded text-[10px] whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
          Need Help?
        </span>
      </button>
    </div>
