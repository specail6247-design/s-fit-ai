...
export default function RealLifeFitting() {
  ...
  const handleShareToStory = async () => {
    ...
    try {
      ...
      ctx.fillText('S_FIT', 540, 250);

      ctx.fillStyle = '#007AFF';
      ctx.fillText('NEO', 540, 340);
      ...
      ctx.shadowBlur = 60;
      ctx.drawImage(img, (1080 - targetWidth) / 2, y, targetWidth, targetHeight);
      ctx.shadowBlur = 0;

      // Footer
      ctx.fillStyle = '#666';
      ctx.font = '500 30px monospace';
      ctx.fillText('GENERATED BY AI • S-FIT.APP', 540, 1800);
      ...
      alert("Could not generate share image. Ensure image allows cross-origin access.");
    }
  };
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <div className="space-y-8 relative z-10 flex-1 overflow-y-auto">
          ...
          {/* Data Safety Badge */}
          <div className="flex items-start gap-3 p-3 bg-green-900/20 border border-green-500/20 rounded-xl">
             <span className="material-symbols-outlined text-green-400 text-xl">security</span>
             <div className="text-[10px] text-gray-400 leading-tight">
               <strong className="text-green-400 block mb-0.5 uppercase tracking-wider">Privacy Protected</strong>
               Photos are processed securely and automatically deleted after use. We do not store personal biometric data.
             </div>
          </div>
        </div>
          ...
          >
            <div className="relative group">
              ...
              <button
                ...
                className="absolute bottom-4 right-4 bg-[#007AFF] text-white px-4 py-2 rounded-xl text-xs font-bold shadow-lg hover:bg-[#0066cc] transition-colors flex items-center gap-2"
              >
