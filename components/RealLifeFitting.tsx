...
export default function RealLifeFitting() {
  ...
  const handleShareToStory = async () => {
    ...
    ctx.fillText('NEO', canvas.width / 2 + 130, 200); // Rough offset

    ctx.font = '40px monospace';
    ctx.fillStyle = '#888888';
    ctx.fillText('VIRTUAL FITTING', canvas.width / 2, 260);
    ...
    ctx.fillStyle = '#444';
    ctx.fillText('GENERATED BY S_FIT AI', canvas.width / 2, canvas.height - 100);
      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <div className="space-y-8 relative z-10 flex-1 overflow-y-auto">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => setPrivacyOpen(true)} className="flex items-center gap-1 text-[10px] text-green-400 hover:text-green-300 transition-colors">
                <span>🔒</span> Secure
              </button>
            </div>
            ...
            <div className="flex items-center gap-2 p-2 bg-white/5 rounded-lg border border-white/5">
              ...
              <p className="text-[10px] text-gray-400">Photos processed securely & deleted after use.</p>
            </div>
          </div>
        ...
        <div className="mt-8 relative z-10">
          ...
          <div className="mt-4 text-center">
             <button onClick={() => setSupportOpen(true)} className="text-[10px] text-gray-500 hover:text-[#007AFF] transition-colors uppercase tracking-widest">
               Support & Feedback
             </button>
          </div>
          ...
          >
            <div className="relative group">
              ...
              <button
                ...
                className="absolute bottom-4 right-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full px-4 py-2 text-xs font-bold flex items-center gap-2 hover:scale-105 transition-transform shadow-lg"
              >
