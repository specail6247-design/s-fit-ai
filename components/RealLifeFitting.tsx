  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
      ...
      <div className="flex-1 relative bg-gradient-to-b from-[#0a0a0a] to-[#111]">
        ...
        {/* Support Button - Hidden until needed philosophy (subtle floating button) */}
        <button
          onClick={() => setIsSupportOpen(true)}
          className="absolute bottom-8 right-8 w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:bg-white/10 hover:text-white transition-all backdrop-blur-md z-30 shadow-lg"
