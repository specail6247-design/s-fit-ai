      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <header className="mb-10 relative z-10 flex justify-between items-start">
          ...
          <div className="flex gap-4">
            ...
            >
              <span className="opacity-0 group-hover:opacity-100 transition-opacity mr-1">Support</span> ℹ️
            </button>
            <button
              onClick={() => setIsMemberModalOpen(true)}
              className="text-[#C9B037]/70 hover:text-[#C9B037] transition-colors text-sm flex items-center gap-1 group"
            >
              <span className="opacity-0 group-hover:opacity-100 transition-opacity mr-1">VIP Login</span> 🔑
            </button>
          </div>
        </header>
