            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group focus-within:ring-2 focus-within:ring-[#007AFF] focus-within:ring-offset-2 focus-within:ring-offset-black">
              ...
              <label htmlFor="user-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  ...
                  {userImage ? <img src={userImage} alt="Uploaded user photo" className="w-full h-full object-cover" /> : <span className="text-2xl" aria-hidden="true">👤</span>}
                </div>
                <div>
          ...
          <div className="space-y-2">
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group focus-within:ring-2 focus-within:ring-[#007AFF] focus-within:ring-offset-2 focus-within:ring-offset-black">
              ...
              <label htmlFor="garment-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  {garmentImage ? <img src={garmentImage} alt="Selected garment" className="w-full h-full object-cover" /> : <span className="text-2xl" aria-hidden="true">👕</span>}
                </div>
                <div>
