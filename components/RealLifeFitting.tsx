            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="user-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  {userImage ? <Image src={userImage} alt="User Upload" width={64} height={64} className="w-full h-full object-cover" unoptimized /> : <span className="text-2xl">👤</span>}
                </div>
                <div>
          ...
          <div className="space-y-2">
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="garment-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  {garmentImage ? <Image src={garmentImage} alt="Garment Upload" width={64} height={64} className="w-full h-full object-cover" unoptimized /> : <span className="text-2xl">👕</span>}
                </div>
                <div>
        ...
        {resultImage && !isProcessing && (
          ...
          >
            <div className="relative group">
              <Image src={resultImage} alt="Virtual Try-On Result" width={500} height={800} className="w-auto h-[70vh] rounded-xl object-contain shadow-2xl" unoptimized />
              <button 
