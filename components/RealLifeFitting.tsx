  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <header className="mb-10 relative z-10 flex justify-between items-start">
          ...
          <button
            ...
            className="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-[10px] uppercase tracking-widest font-bold hover:bg-[#CCFF00] hover:text-black hover:border-[#CCFF00] transition-colors"
          >
            Sign In
          </button>
        </header>
      ...
      <div className="flex-1 relative bg-gradient-to-b from-[#0a0a0a] to-[#111]">
        ...
        {/* Floating Support Hub Button */}
        <button
          onClick={() => setIsSupportHubOpen(true)}
          className="absolute bottom-6 right-6 z-30 w-12 h-12 bg-white/10 backdrop-blur-md border border-white/20 rounded-full flex items-center justify-center text-white hover:bg-[#007AFF] hover:border-[#007AFF] transition-all shadow-lg group"
        >
