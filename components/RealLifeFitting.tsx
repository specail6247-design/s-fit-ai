      ...
      <div className="w-1/3 min-w-[400px] h-full p-8 flex flex-col z-10 glass-panel border-r border-white/10 relative">
        ...
        <header className="mb-10 relative z-10 flex justify-between items-start">
          ...
          <div className="flex flex-col gap-2 items-end">
            <AuthButton />
            <button onClick={() => setIsSupportOpen(true)} className="text-[10px] tracking-widest text-gray-400 hover:text-white uppercase border border-white/10 px-3 py-1 rounded-full bg-white/5 transition-colors">
              Help & Support
            </button>
          </div>
        </header>
              ...
              <label htmlFor="user-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  {userImage ? (
                    ...
                    <img src={userImage} alt="User photo upload preview" className="w-full h-full object-cover" />
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="garment-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  {garmentImage ? (
                    /* eslint-disable-next-line @next/next/no-img-element */
                    <img src={garmentImage} alt="Garment photo upload preview" className="w-full h-full object-cover" />
                  ) : <span className="text-2xl">👕</span>}
                </div>
                <div>
