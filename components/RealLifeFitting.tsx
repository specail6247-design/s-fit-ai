    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans flex overflow-hidden">
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="user-upload" className="cursor-pointer flex items-center gap-4">
                <div className="relative w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  {userImage ? <Image src={userImage} fill className="object-cover" alt="User photo upload preview" unoptimized /> : <span className="text-2xl">👤</span>}
                </div>
                <div>
          ...
          <div className="space-y-2">
            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="garment-upload" className="cursor-pointer flex items-center gap-4">
                <div className="relative w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  {garmentImage ? <Image src={garmentImage} fill className="object-cover" alt="Target garment upload preview" unoptimized /> : <span className="text-2xl">👕</span>}
                </div>
                <div>
      ...
      <div className="flex-1 relative bg-gradient-to-b from-[#0a0a0a] to-[#111]">
        ...
        {resultImage && !isProcessing && (
          ...
          >
            <div className="relative group w-[90vw] max-w-[500px] h-[70vh]">
              <Image src={resultImage} alt="AI Generated Fitting Result" fill className="rounded-xl object-contain shadow-2xl" unoptimized />
              <button 
