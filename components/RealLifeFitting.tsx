            ...
            <div className="border border-white/20 bg-black/40 rounded-xl p-4 hover:border-[#007AFF] transition-colors group">
              ...
              <label htmlFor="user-upload" className="cursor-pointer flex items-center gap-4">
                <div className="w-16 h-16 bg-gray-800 rounded-lg flex items-center justify-center overflow-hidden border border-white/10">
                  ...
                  {userImage ? <img src={userImage} className="w-full h-full object-cover" alt="User Image" /> : <span className="text-2xl">👤</span>}
                </div>
                <div>
          ...
          >
            <div className="relative group">
              ...
              <button 
                ...
                className="absolute top-4 right-4 bg-black/60 text-white rounded-full p-2 hover:bg-[#007AFF] transition-colors focus-visible:ring-2 focus-visible:ring-[#007AFF]"
