      ...
      >
        ...
        <header className="mb-10 relative z-10">
          <motion.h1
            ...
            className="text-4xl font-cinzel font-black tracking-tighter italic"
          >
          ...
          <motion.p
            ...
            className="text-xs text-gray-400 tracking-[0.3em] uppercase mt-2"
          >
        ...
        {resultImage && !isProcessing && (
          ...
          >
            <div className="relative group">
              <div className="w-auto h-[70vh] aspect-[2/3] rounded-xl overflow-hidden saturate-90 contrast-110">
