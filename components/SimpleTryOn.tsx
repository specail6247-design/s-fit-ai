      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <div className="relative w-full h-full" style={styles.preview}><Image src={userImage} fill style={{ objectFit: 'contain' }} alt="User" unoptimized /></div>}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <div className="relative w-full h-full" style={styles.preview}><Image src={clothingImage} fill style={{ objectFit: 'contain' }} alt="Cloth" unoptimized /></div>}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div className="relative w-full h-full" style={styles.finalImg}><Image src={finalResult} fill style={{ objectFit: 'contain' }} alt="Result" unoptimized /></div>
          </div>
        )}
      </main>
    </div>
