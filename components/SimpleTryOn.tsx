      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <img src={userImage} style={styles.preview} alt="User uploaded photo" />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <img src={clothingImage} style={styles.preview} alt="Garment photo" />}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <img src={finalResult} style={styles.finalImg} alt="Virtual try-on result" />
          </div>
        )}
      </main>
    </div>
