        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <Image src={userImage} fill style={{ objectFit: 'cover' }} alt="User" />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <Image src={clothingImage} fill style={{ objectFit: 'cover' }} alt="Cloth" />}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{ position: 'relative', ...styles.finalImg }}>
              <Image src={finalResult} fill style={{ objectFit: 'contain' }} alt="Result" />
            </div>
          </div>
        )}
      </main>
