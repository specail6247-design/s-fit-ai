      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && (
                <div style={{ position: 'relative', ...styles.preview }}>
                  <Image src={userImage} alt="User" unoptimized fill style={{ objectFit: 'cover' }} />
                </div>
              )}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && (
                <div style={{ position: 'relative', ...styles.preview }}>
                  <Image src={clothingImage} alt="Cloth" unoptimized fill style={{ objectFit: 'cover' }} />
                </div>
              )}
            </div>
          </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{ position: 'relative', ...styles.finalImg }}>
              <Image src={finalResult} alt="Result" unoptimized fill style={{ objectFit: 'contain' }} />
            </div>
          </div>
        )}
      </main>
