      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <Image src={userImage} width={200} height={200} style={styles.preview} alt="User photo" unoptimized />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <Image src={clothingImage} width={200} height={200} style={styles.preview} alt="Garment photo" unoptimized />}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <Image src={finalResult} width={400} height={600} style={styles.finalImg} alt="Fitting result" unoptimized />
          </div>
        )}
      </main>
    </div>
