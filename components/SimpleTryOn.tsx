      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && (
                <div style={{ position: 'relative', width: '100%', height: '200px', marginTop: '10px' }}>
                  <Image src={userImage} alt="User" fill style={{ objectFit: 'cover', borderRadius: '10px' }} unoptimized />
                </div>
              )}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && (
                <div style={{ position: 'relative', width: '100%', height: '200px', marginTop: '10px' }}>
                  <Image src={clothingImage} alt="Cloth" fill style={{ objectFit: 'cover', borderRadius: '10px' }} unoptimized />
                </div>
              )}
            </div>
          </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{ position: 'relative', maxWidth: '100%', height: '600px', width: '400px', margin: '0 auto' }}>
              <Image
                src={finalResult}
                alt="Result"
                fill
                style={{ objectFit: 'contain', borderRadius: '20px', boxShadow: '0 20px 40px rgba(0,0,0,0.5)' }}
                unoptimized
              />
            </div>
          </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  // preview style removed as it's handled by Next Image wrapper div
