      ...
      <main style={styles.main}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && (
                <>
                  ...
                  <img src={userImage} style={styles.preview} alt="User Photo" />
                </>
              )}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && (
                <>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={clothingImage} style={styles.preview} alt="Garment Photo" />
                </>
              )}
            </div>
          </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={finalResult} style={styles.finalImg} alt="Result Photo" />
          </div>
        )}
      </main>
    </div>
