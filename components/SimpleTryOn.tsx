      ...
      <main style={styles.main}>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{ position: 'relative', maxWidth: '100%', height: '500px' }}>
               <Image src={finalResult} fill style={{ objectFit: 'contain', borderRadius: '20px', boxShadow: '0 20px 40px rgba(0,0,0,0.5)' }} alt="Result" unoptimized />
            </div>
          </div>
        )}
      </main>
