        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <div style={{position: 'relative', width: '100%', height: '200px'}}><Image src={userImage} style={styles.preview} alt="User" fill /></div>}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <div style={{position: 'relative', width: '100%', height: '200px'}}><Image src={clothingImage} style={styles.preview} alt="Cloth" fill /></div>}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{position: 'relative', width: '100%', height: '600px'}}>
              <Image src={finalResult} style={styles.finalImg} alt="Result" fill unoptimized />
            </div>
          </div>
        )}
      </main>
