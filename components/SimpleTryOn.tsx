      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <div style={{position:"relative", ...styles.preview}}><Image src={userImage} fill style={{objectFit:"cover"}} alt="User" unoptimized /></div>}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <div style={{position:"relative", ...styles.preview}}><Image src={clothingImage} fill style={{objectFit:"cover"}} alt="Cloth" unoptimized /></div>}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{position:"relative", ...styles.finalImg}}><Image src={finalResult} fill style={{objectFit:"contain"}} alt="Result" unoptimized /></div>
          </div>
        )}
      </main>
    </div>
