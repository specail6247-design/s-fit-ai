      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <div style={{...styles.preview, position: 'relative'}}><Image src={userImage} fill unoptimized style={{objectFit: 'cover'}} alt="User Photo" /></div>}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <div style={{...styles.preview, position: 'relative'}}><Image src={clothingImage} fill unoptimized style={{objectFit: 'cover'}} alt="Target Garment" /></div>}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{...styles.finalImg, position: 'relative'}}><Image src={finalResult} fill unoptimized style={{objectFit: 'contain'}} alt="Virtual Try-On Result" /></div>
          </div>
        )}
      </main>
    </div>
