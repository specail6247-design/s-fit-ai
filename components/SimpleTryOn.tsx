      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <Image unoptimized width={300} height={300} src={userImage} style={styles.preview} alt="User" />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <Image unoptimized width={300} height={300} src={clothingImage} style={styles.preview} alt="Cloth" />}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <Image unoptimized width={600} height={800} src={finalResult} style={styles.finalImg} alt="Result" />
          </div>
        )}
      </main>
    </div>
