        ...
        <div style={styles.grid}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && (
                <div style={{ position: 'relative', width: '100%', height: '200px', marginTop: '10px' }}>
                  <Image src={userImage} fill style={{ borderRadius: '10px', objectFit: 'cover' }} alt="User" unoptimized />
                </div>
              )}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && (
                <div style={{ position: 'relative', width: '100%', height: '200px', marginTop: '10px' }}>
                  <Image src={clothingImage} fill style={{ borderRadius: '10px', objectFit: 'cover' }} alt="Cloth" unoptimized />
                </div>
              )}
            </div>
          </div>
