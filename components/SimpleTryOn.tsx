        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={{ ...styles.uploadBox, position: 'relative' }}>
              ...
              {userImage && <Image src={userImage} fill style={{ objectFit: 'cover' }} alt="User" unoptimized />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={{ ...styles.uploadBox, position: 'relative' }}>
              ...
              {clothingImage && <Image src={clothingImage} fill style={{ objectFit: 'cover' }} alt="Cloth" unoptimized />}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{ position: 'relative', width: '100%', height: '500px' }}>
              <Image src={finalResult} fill style={{ objectFit: 'contain' }} alt="Result" unoptimized />
            </div>
          </div>
        )}
      </main>
