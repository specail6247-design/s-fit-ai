      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <Image src={userImage} style={styles.preview} alt="User" width={100} height={100} />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <Image src={clothingImage} style={styles.preview} alt="Cloth" width={100} height={100} />}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <Image src={finalResult} style={styles.finalImg} alt="Result" width={300} height={400} />
          </div>
        )}
      </main>
    </div>
