      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <div style={{position: 'relative', width: '100%', height: '200px'}}><Image src={userImage} fill style={{objectFit: 'contain'}} alt="User upload preview" unoptimized /></div>}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <div style={{position: 'relative', width: '100%', height: '200px'}}><Image src={clothingImage} fill style={{objectFit: 'contain'}} alt="Garment upload preview" unoptimized /></div>}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{position: 'relative', width: '100%', height: '400px'}}><Image src={finalResult} fill style={{objectFit: 'contain'}} alt="Final AI generated fitting result" unoptimized /></div>
          </div>
        )}
      </main>
    </div>
