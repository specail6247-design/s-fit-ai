      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <img src={userImage} style={styles.preview} alt="User photo upload preview" />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              {clothingImage && <img src={clothingImage} style={styles.preview} alt="Garment photo upload preview" />}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={finalResult} style={styles.finalImg} alt="Virtual Fitting Result" />
          </div>
        )}
      </main>
    </div>
