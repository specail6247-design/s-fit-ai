        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <Image src={userImage} style={styles.preview} alt="User" width={400} height={400} unoptimized />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <Image src={clothingImage} style={styles.preview} alt="Cloth" width={400} height={400} unoptimized />}
            </div>
          </div>
        </div>
