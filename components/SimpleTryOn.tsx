      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <img src={userImage} alt="User" style={styles.preview} />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <img src={clothingImage} alt="Cloth" style={styles.preview} />}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <img src={finalResult} alt="Result" style={styles.finalImg} />
          </div>
        )}
      </main>
    </div>
