        ...
        <div style={styles.grid}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && (
                 <div style={{ position: 'relative', width: '100%', height: '200px', marginTop: '10px' }}>
                    <Image src={userImage} style={{ borderRadius: '10px', objectFit: 'cover' }} alt="User" fill unoptimized />
                 </div>
              )}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && (
                 <div style={{ position: 'relative', width: '100%', height: '200px', marginTop: '10px' }}>
                    <Image src={clothingImage} style={{ borderRadius: '10px', objectFit: 'cover' }} alt="Cloth" fill unoptimized />
                 </div>
              )}
            </div>
          </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{ position: 'relative', width: '100%', height: '600px' }}>
               <Image src={finalResult} style={{ borderRadius: '20px', objectFit: 'contain' }} alt="Result" fill unoptimized />
            </div>
          </div>
        )}
      </main>
