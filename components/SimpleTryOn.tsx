      ...
      <main style={styles.main}>
        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && <Image src={userImage} unoptimized width={200} height={200} style={styles.preview} alt="User" />}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && <Image src={clothingImage} unoptimized width={200} height={200} style={styles.preview} alt="Cloth" />}
            </div>
          </div>
        </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <Image src={finalResult} unoptimized width={400} height={500} style={styles.finalImg} alt="Result" />
          </div>
        )}
      </main>
    </div>
