        ...
        <div style={styles.grid}>
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {userImage && (
                <div style={{ position: 'relative', width: '100%', height: '300px', marginTop: '1rem' }}>
                  <Image src={userImage} alt="User" fill unoptimized style={{ objectFit: 'contain' }} />
                </div>
              )}
            </div>
          </div>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.uploadBox}>
              ...
              {clothingImage && (
                <div style={{ position: 'relative', width: '100%', height: '300px', marginTop: '1rem' }}>
                  <Image src={clothingImage} alt="Cloth" fill unoptimized style={{ objectFit: 'contain' }} />
                </div>
              )}
            </div>
          </div>
        ...
        {finalResult && (
          <div style={styles.resultContainer}>
            ...
            <div style={{ position: 'relative', width: '100%', height: '600px' }}>
              <Image src={finalResult} alt="Result" fill unoptimized style={{ objectFit: 'contain' }} />
            </div>
          </div>
        )}
      </main>
