...
import { Geist, Geist_Mono, Cinzel, Space_Grotesk, Inter } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${cinzel.variable} ${spaceGrotesk.variable} ${inter.variable} antialiased bg-void-black text-pure-white font-inter`}
